...
public class Mintest
{
            ...
            return new[]
            {
                new object[]
                {
                    ...
                    new IInput[]
                    {
                        ...
                        new Edge(new Variable("b", new RealType(),0.5)),
                ...
                new object[]
                {
                    ...
                    new IInput[]
                    {
                        new Edge(new Variable("a", new IntegerType(),12)),
    ...
    {
        Assert.ThrowsException<NullReferenceException>(() => new Min(output, inputs));
    }
    ...
    {
        Assert.ThrowsException<IrregularInputException>(() => new Min(output, inputs));
    }
    ...
    {
        Assert.ThrowsException<IrregularOutputException>(() => new Min(output, inputs));
    }
    ...
    {
        Operation op = new Min(output, inputs);
        op.CalcResult();
